...
🛠️ عیب‌یابی سریع
مشکل	راه حل
فایل دیتابیس پیدا نشد	فایل x-ui.db را در پوشه جاری قرار دهید
خطا در اتصال به مرزبان	آدرس، پورت و رمز را بررسی کنید
اینباند VLESS یافت نشد	ابتدا در مرزبان اینباند VLESS بسازید
خطای 500 در ایجاد کاربر	معمولاً خودکار مدیریت می‌شود
